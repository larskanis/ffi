...
import ffi.AbstractMemory;
import ffi.ArrayMemoryIO;
import ffi.Buffer;
import ffi.CallbackInfo;
import ffi.Enums;
import ffi.MappedType;
import ffi.MemoryIO;
import ffi.MemoryPointer;
import ffi.NativeType;
import ffi.Platform;
import ffi.Struct;
import ffi.StructByValue;
...
public final class DefaultMethodFactory extends MethodFactory {
    ...
    static ParameterMarshaller getMarshaller(Type type, CallingConvention convention, IRubyObject enums) {
        ...
        if (type instanceof Type.Builtin) {
        ...
        } else if (type instanceof ffi.CallbackInfo) {
            ...
            return new StructByValueMarshaller((ffi.StructByValue) type);
    ...
    static final class StructByValueMarshaller extends NonSessionMarshaller {
        ...
        public StructByValueMarshaller(ffi.StructByValue sbv) {
