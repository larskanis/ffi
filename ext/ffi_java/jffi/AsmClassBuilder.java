...
import static org.jruby.org.objectweb.asm.Opcodes.*;
...
final class AsmClassBuilder {
    ...
    public static ClassVisitor newCheckClassAdapter(ClassVisitor cv) {
        try {
            Class<? extends ClassVisitor> tmvClass = Class.forName("org.jruby.org.objectweb.asm.util.CheckClassAdapter").asSubclass(ClassVisitor.class);
    ...
    public static final ClassVisitor newTraceClassVisitor(PrintWriter out) {
        try {
            ...
            Class<? extends ClassVisitor> tmvClass = Class.forName("org.jruby.org.objectweb.asm.util.TraceClassVisitor").asSubclass(ClassVisitor.class);
