...
public final class Function extends ffi.AbstractInvoker {
    ...
    public static IRubyObject newInstance(ThreadContext context, IRubyObject recv, IRubyObject[] args, Block block) {
        ...
        Type returnType = ffi.Util.findType(context, args[0]);
        ...
        for (int i = 0; i < parameterTypes.length; ++i) {
            parameterTypes[i] = ffi.Util.findType(context, paramTypes.entry(i));
        }
